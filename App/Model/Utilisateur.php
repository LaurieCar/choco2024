...
class Utilisateur extends BddConnect{
    ...
    public function getUtilisateurByMail(): Utilisateur|bool {
        try {
            $mail = $this->mail_utilisateur;
            $requete = $this->connexion()->prepare('SELECT id_utilisateur,nom_utilisateur,prenom_utilisateur,mail_utilisateur,password_utilisateur,image_utilisateur FROM utilisateur WHERE mail_utilisateur = ?');
